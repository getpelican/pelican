...
class TestUtils(LoggedTestCase):
    ...
    def test_get_date(self):
        ...
        date_hour_z = utils.SafeDatetime(
            year=2012, month=11, day=22, hour=22, minute=11, tzinfo=pytz.timezone("UTC")
        )
        date_hour_est = utils.SafeDatetime(
            year=2012, month=11, day=22, hour=22, minute=11, tzinfo=pytz.timezone("EST")
        )
    ...
    def test_slugify_substitute(self):
        ...
        settings = read_settings()
        subs = [(r"C\+\+", "CPP"), (r"C#", "C-SHARP"),] + settings[
    ...
    def test_filesystemwatcher(self):
        ...
        create_file(
            os.path.join(content_path, "article.md"), "Title: test\n" "Date: 01-01-2020"
        )
