...
DEFAULT_CONFIG = {
    ...
    'DRAFT_URL': posix_join('drafts', '{slug}.html'),
    'DRAFT_SAVE_AS': posix_join('drafts', '{slug}.html'),
    'DRAFT_LANG_URL': posix_join('drafts', '{slug}-{lang}.html'),
    'DRAFT_LANG_SAVE_AS': posix_join('drafts', '{slug}-{lang}.html'),
    'PAGE_URL': posix_join('pages', '{slug}.html'),
    'PAGE_SAVE_AS': posix_join('pages', '{slug}.html'),
    'PAGE_ORDER_BY': 'basename',
    'PAGE_LANG_URL': posix_join('pages', '{slug}-{lang}.html'),
    'PAGE_LANG_SAVE_AS': posix_join('pages', '{slug}-{lang}.html'),
    'DRAFT_PAGE_URL': posix_join('drafts', 'pages', '{slug}.html'),
    'DRAFT_PAGE_SAVE_AS': posix_join('drafts', 'pages', '{slug}.html'),
    'DRAFT_PAGE_LANG_URL': posix_join('drafts', 'pages', '{slug}-{lang}.html'),
    ...
    'CATEGORY_URL': posix_join('category', '{slug}.html'),
    'CATEGORY_SAVE_AS': posix_join('category', '{slug}.html'),
    'TAG_URL': posix_join('tag', '{slug}.html'),
    'TAG_SAVE_AS': posix_join('tag', '{slug}.html'),
    'AUTHOR_URL': posix_join('author', '{slug}.html'),
