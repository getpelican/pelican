...
AUTHOR_URL (`Default:` output/author/`author_name'n'`.html).
...
dates_page              The current page of articles, ordered by date,
                        ascending.
page_name               AUTHOR_URL where `{name}` is the author's name 
...
If pagination is active, subsequent pages will reside as defined by setting
CATEGORY_URL (`Default:` output/category/`category_name'n'`.html).
...
dates_page              The current page of articles, ordered by date,
                        ascending
page_name               CATEGORY_URL where `{name}` is the category name
                        -- useful for pagination links
===================     ===================================================
...
TAG_URL (`Default:` output/tag/`tag_name'n'`.html).
...
dates_page              The current page of articles, ordered by date,
                        ascending
page_name               TAG_URL where `{name}` is the tag name 
                        -- useful for pagination links
===================     ===================================================
